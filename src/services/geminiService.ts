...
export const generateGeminiResponse = async (prompt: string): Promise<GeminiResponse> => {
  try {
            ...
            parts: [
              {
                ...
                - India Offices: #11, Bhannergerghatta road, Bangalore, Karnataka, India Pincode-560076 | Flat - 14, Block-B, Maheshwari Towers, Prem Nagar Rd, Shyam Rao Nagar, Banjara Hills, Hyderabad, Telangana 500034
    ...
    if (data.error) {
      ...
      return {
        text: "I'm sorry, I encountered an error processing your request. Please try again later or contact our support team directly at hr@bioclinpharm.com or call +91-9182665924 / +91-9390281309.",
    ...
    const generatedText = data.candidates?.[0]?.content?.parts?.[0]?.text ||
      "I'm sorry, I couldn't generate a response at this time. Please contact our team at hr@bioclinpharm.com or call +91-9182665924 / +91-9390281309 for assistance.";

    return { text: generatedText };
  } catch (error) {
    console.error("Error calling Gemini API:", error);
    return {
      text: "I'm sorry, I encountered an error. Please try again later or contact our support team directly at hr@bioclinpharm.com or call +91-9182665924 / +91-9390281309.",
...
const getFallbackResponse = (prompt: string): GeminiResponse => {
  ...
  if (lowercasePrompt.includes("customer support") || lowercasePrompt.includes("help")) {
    return {
      text: "Our customer support team is available Monday to Friday, 9 AM to 5 PM IST. You can reach us at hr@bioclinpharm.com or call +91-9182665924 / +91-9390281309 for immediate assistance."
    };
  }
    ...
    return {
      text: "We have offices in the USA (332 Sugartown Road, Devon, Pennsylvania, 19333) and India (#11, Bhannergerghatta road, Bangalore, Karnataka, India Pincode-560076 | Flat - 14, Block-B, Maheshwari Towers, Prem Nagar Rd, Shyam Rao Nagar, Banjara Hills, Hyderabad, Telangana 500034). Our teams work collaboratively across these locations to serve clients globally."
    };
  }
    ...
    return {
      text: "You can contact us at hr@bioclinpharm.com or call +91-9182665924 / +91-9390281309 for any inquiries. We're available Monday to Friday, 9 AM to 5 PM IST."
    };
  }
