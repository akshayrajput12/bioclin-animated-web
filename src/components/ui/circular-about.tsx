...
const sizeConfig = {
    sm: {
        container: 'h-[300px] w-[300px] sm:h-[350px] sm:w-[350px]',
    ...
    md: {
        container: 'h-[350px] w-[350px] sm:h-[400px] sm:w-[400px] md:h-[450px] md:w-[450px]',
    ...
    lg: {
        container: 'h-[400px] w-[400px] sm:h-[500px] sm:w-[500px] md:h-[600px] md:w-[600px] lg:h-[700px] lg:w-[700px]',
